...
<body id="bull">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="bulletin.php">Bulletins</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid">
        <h2 class="text-center"> Liste des Bulletins</h2>
        <div class="row">
            <div class="col-lg-10">
                <select class="btn slt me-2" id="bulletin_classe" onchange="bulletin();">
            ...
            <div class="col-lg-2">
                <input class="form-control" onkeyup=" recherche_bulletin();" name=" search" id="nom" type="text"
        ...
        <div class="table-header">
            <table class="table">
                <thead>
                    <tr>
                        <th width="25%" width="25%">Nom</th>
                        <th width="25%">Prénom</th>
                        <th width="25%">Classe</th>
                        <th width="25%" class="text-center">Consulter</th>
                    </tr>
                </thead>
            </table>
