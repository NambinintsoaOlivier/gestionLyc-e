...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-10">
                <a class="btn btn-primary me-2" href="nouv_etudiant.php">Nouveau Etudiant</a>
                <select class="btn slt bg-outline-success" id="classe" onchange="classe();">
            ...
            <div class="col-lg-2">
                <input class="form-control" onkeyup=" rechercheEtudiant();" name=" nom" id="nom" type="text"
        ...
        <div class="table-body">
            <table class="table">
                <tbody id="search_elev">
                    ...
                    <tr class="liste">
                        <td width="13%">
                            <a href="info.php?inform=<?php echo $row['id_elev'] ?>">
                                <?php echo $row['nom_elev'];  ?></a>
                        </td>
                        <td width="15%">
                        ...
                        <td width="20%" class="text-center">
                            <a class="btn btn-danger"
                                href="action.php?delete=<?php echo $row['id_elev'] ?>">Supprimer</a>
                            <a class="btn btn-success"
                                href="nouv_etudiant.php?editeEtudiant=<?php echo $row['id_elev'] ?>">Modifier</a>
